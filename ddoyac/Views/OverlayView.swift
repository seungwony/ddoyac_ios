...
class OverlayView: UIView {
  ...
  private let stringHorizontalSpacing: CGFloat = 10.0
//  private let stringVerticalSpacing: CGFloat = 7.0
    private let stringVerticalSpacing: CGFloat = -18.0
...
//      drawBackground(of: objectOverlay)
    ...
    for objectOverlay in ocrOverlays {
